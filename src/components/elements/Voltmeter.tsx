...
interface VoltmeterProps { x: number; y: number; values?: CalculatedValues; isSelected: boolean; onClick: (e: React.MouseEvent) => void; rotation?: number; pol0?: string; pol1?: string; }

export function Voltmeter({ x, y, values, isSelected, onClick, rotation, pol0, pol1 }: VoltmeterProps) {
  const r = rotation || 0;
